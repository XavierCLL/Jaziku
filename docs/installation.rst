...
- `jaziku 0.7.0 <https://docs.google.com/uc?id=0B2KQf7Dbx7DULWxObVJjZWQzVmM&export=download>`_
...
- Go into downloaded file an run this command to install
  (as root or use sudo):
    ...
    easy_install jaziku-0.7.0-py2.7.egg
...
- If you have installed old version, for update to new version use (using egg):
    ...
    easy_install -U jaziku-0.7.0-py2.7.egg
