...
particular_properties_probabilistic_map = {"tiMainFontHeightF":0.02,  # main font height
                             "lbTitleFontHeightF":0.012,  # colorbar title font height
                             "space_label_title":20,  # number of space between label title in colorbar
                             "lbLabelFontHeightF":0.0075}  # colorbar mark font height